 ...
 * @param {Boolean} isIgnoreURLEncode, 是否忽略URLEncode，5.4之前版本，app->bridge.js的参数都是URLEncode之后的，该值为false，5.4之后，是未URLEncode的，该值为true
 * @since v5.2
 * @author jimzhao
 */
function __bridge_callback(param, isIgnoreURLEncode) {
    if (!isIgnoreURLEncode) {
...
var CtripBar = {
     ...
     * @example
        ...
        var nav_json = {
            ...
            "centerButton": [{"tagname": "cityChoose", "value":"上海", "a_icon":"arrow_up", "i_icon":"arrow_up.png"}], //from 5.5version

...
var Internal = {
    ...
    isAppVersionAfter62:function() {
       ...
       if (uaFlagIndex >= 0) {
           ...
           __IS_BASE64_ENCODE_VERSION = (intVer >= 62) ;
       }
   ...
   /**
    ...
    makeURLWithParam:function(paramString) {
        ...
        paramString = CtripTool.ctripParamEncode(paramString);
...
var CtripTool = {
 ...
 ctripParamDecode:function(param) {
    if (Internal.isAppVersionAfter62()) {
        param = base64DecToArr(param);// CtripTool.base64Decode(param);        
 ...
 ctripParamEncode:function(param) {
    if (Internal.isAppVersionAfter62()) {
        param = base64EncArr(param);// CtripTool.base64Encode(param); 
    } 
    else {
